<?php /* Smarty version Smarty-3.1.21, created on 2017-06-29 16:32:52
         compiled from "F:\xampp\htdocs\bridges\airline\travelportNew1.1\views\AirCreateReservationReqXml.tpl" */ ?>
<?php /*%%SmartyHeaderCode:162185954de5c49a814-42996808%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9e3ed210cf8181a783a8c70ee57647660aeca840' => 
    array (
      0 => 'F:\\xampp\\htdocs\\bridges\\airline\\travelportNew1.1\\views\\AirCreateReservationReqXml.tpl',
      1 => 1498114869,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '162185954de5c49a814-42996808',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5954de5ccbca89_78140487',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5954de5ccbca89_78140487')) {function content_5954de5ccbca89_78140487($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'F:\\xampp\\htdocs\\bridges\\airline\\travelportNew1.1\\core\\smarty\\libs\\plugins\\modifier.date_format.php';
?><AirCreateReservationReq xmlns="http://www.travelport.com/schema/universal_v40_0" TraceId="<?php echo $_smarty_tpl->tpl_vars['_Ainput']->value['traceId'];?>
...
?>
	...
	<BookingTraveler xmlns="http://www.travelport.com/schema/common_v40_0" <?php if ($_smarty_tpl->tpl_vars['_Ainput']->value['PassengerType'][((string)$_smarty_tpl->tpl_vars['_Ainput']->value['paxDetails'][$_smarty_tpl->getVariable('smarty')->value['section']['pax']['index']]['paxTypeKeyIdx'])]!='') {?> Key='<?php echo $_smarty_tpl->tpl_vars['_Ainput']->value['PassengerType'][((string)$_smarty_tpl->tpl_vars['_Ainput']->value['paxDetails'][$_smarty_tpl->getVariable('smarty')->value['section']['pax']['index']]['paxTypeKeyIdx'])];?>
...
"/>
	...
	<?php }?>
	<ContinuityCheckOverride xmlns="http://www.travelport.com/schema/common_v40_0" Key="1">Yes</ContinuityCheckOverride>

	<AgencyContactInfo xmlns="http://www.travelport.com/schema/common_v40_0">
...
" />
	...
	<?php if ($_smarty_tpl->tpl_vars['_Ainput']->value['providerCode']['ProviderCode']=='1G') {?>
	<FormOfPayment Type="MiscFormOfPayment" xmlns="http://www.travelport.com/schema/common_v40_0">
	...
	<FormOfPayment xmlns="http://www.travelport.com/schema/common_v40_0" Type="Credit" Key="1">
...
">
	...
	<?php } else { ?>
		<?php if (isset($_smarty_tpl->tpl_vars['_Ainput']->value['supplierAgencyPayment'])&&!empty($_smarty_tpl->tpl_vars['_Ainput']->value['supplierAgencyPayment'])) {?>
			<FormOfPayment xmlns="http://www.travelport.com/schema/common_v40_0" Type="AgencyPayment">
...
?>
	...
	<AirPricingSolution xmlns="http://www.travelport.com/schema/air_v40_0"  Key="<?php echo $_smarty_tpl->tpl_vars['_Ainput']->value['AirPricingSolution'][$_smarty_tpl->getVariable('smarty')->value['section']['AirPriceSol']['index']]['attributes']['Key'];?>
...
?>
		<HostToken xmlns="http://www.travelport.com/schema/common_v40_0" Key="<?php echo $_smarty_tpl->tpl_vars['_Ainput']->value['AirPricingSolution'][$_smarty_tpl->getVariable('smarty')->value['section']['AirPriceSol']['index']]['HostToken'][$_smarty_tpl->getVariable('smarty')->value['section']['HostTokenArr']['index']]['attributes']['Key'];?>
...
" <?php }?> xmlns="http://www.travelport.com/schema/common_v40_0"  AirSegmentRef="<?php echo $_smarty_tpl->tpl_vars['_Ainput']->value['OptionalServices'][$_smarty_tpl->getVariable('smarty')->value['section']['optService']['index']]['ServiceData'][$_smarty_tpl->getVariable('smarty')->value['section']['serviceDataLoop']['index']]['attributes']['AirSegmentRef'];?>
...
">
			...
			<?php endfor; endif; ?>
			<ServiceInfo xmlns="http://www.travelport.com/schema/common_v40_0">
...
<?php if ($_smarty_tpl->tpl_vars['_Ainput']->value['providerCode']['ProviderCode']=='1G') {?>
	<ActionStatus xmlns="http://www.travelport.com/schema/common_v40_0" Type="ACTIVE" TicketDate="<?php echo smarty_modifier_date_format('+2 days','%d%b%y');?>
" ProviderCode="<?php echo $_smarty_tpl->tpl_vars['_Ainput']->value['providerCode']['ProviderCode'];?>
" ></ActionStatus>
<?php } else { ?>
	<ActionStatus xmlns="http://www.travelport.com/schema/common_v40_0" Type="ACTIVE" TicketDate="T*" ProviderCode="<?php echo $_smarty_tpl->tpl_vars['_Ainput']->value['providerCode']['ProviderCode'];?>
" ></ActionStatus>
<?php }?>	
