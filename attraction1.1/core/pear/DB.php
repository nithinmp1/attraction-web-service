...
class DB
{
    ...
    function errorMessage($value)
    {
		...
		/*
		//Due to the warning messages i have commanded the code
		
		$logmsg = date('d-m-Y H:i:s')." , ";
		$err = isset($errorMessages[$value]) ? $errorMessages[$value] : $errorMessages[DB_ERROR];
		$logmsg = $logmsg . $err ." \n";
		$todaydate = date("d-m-Y");
		$logfilepath = $_SESSION['path']."pear/err/errlog$todaydate.csv";
