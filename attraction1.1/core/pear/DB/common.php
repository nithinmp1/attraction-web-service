...
//require_once '/home/Staging/expense/pear/PEAR.php';

//echo "<pre>dsfasd232123fsdf";exit;
...
class DB_common extends PEAR
{
    ...
    function &query($query, $params = array())
    {
        if (sizeof($params) > 0) {
			...
			$sqlSetNamesUtf8="set names utf8";
            $resultSetNamesUtf8 = $this->simpleQuery($sqlSetNamesUtf8);
