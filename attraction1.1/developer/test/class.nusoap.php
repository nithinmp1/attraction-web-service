...
class nusoap_client extends nusoap_base  {
	...
	var $faultstring;
	var $faultdetail;
	function nusoap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 360, $portName = ''){
		parent::nusoap_base();
	...
	function getSoapMessage($operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
