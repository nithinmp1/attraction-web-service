...
class PaymentTransaction extends Execute
{
	...
	public function _modifyData()
	{
		...
		$this->paymentAgentName 	= $this->_Asettings['apiPaymentInfo']['agentName'];
		$this->paymentAgentEmail 	= $this->_Asettings['apiPaymentInfo']['agentEmail'];
	...
	function _paymentTransaction($_Aresponse, $_AinputData)
	{
		...
		if($_Aresponse['success']==1){
			...
			if($this->_Ainput['userName']!='Zaraholidays' && $this->_Ainput['userName']!='Thanjai Travels' ){
