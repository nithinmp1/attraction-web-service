	...
	function _storeBookingInfo($_AattractionRes)
	{
		...
		if(isset($_AattractionRes['data']['tickets']))
		{
			...
			foreach($_AattractionRes['data']['tickets'] as $_AticektKey => $_AticketVal)
			{
				...
				$_Smarkup_type 		= '';	
				$_Smarkup_source 	= '';
				$_IsMarkupApplied 	= false;
				if( isset($_MarkupArray[$_AaccountId]) ){
					
					if(isset($_MarkupArray[$_AaccountId][$_AapiId])){
						
						if(isset($_MarkupArray[$_AaccountId][$_AapiId][$_CountryIdIs][$_AticketVal['attraction']['id']])){
							
							$_AttractionValues = $_MarkupArray[$_AaccountId][$_AapiId][$_CountryIdIs][$_AticketVal['attraction']['id']];
	
						}else if(isset($_MarkupArray[$_AaccountId][$_AapiId][$_CountryIdIs][0])){
							
							$_AttractionValues = $_MarkupArray[$_AaccountId][$_AapiId][$_CountryIdIs][0];
							
						}else if(isset($_MarkupArray[$_AaccountId][$_AapiId][0][0])){
							$_AttractionValues = $_MarkupArray[$_AaccountId][$_AapiId][0][0];
							
						}else if(isset($_MarkupArray[$_AaccountId][0][0][0])){
							$_AttractionValues = $_MarkupArray[$_AaccountId][$_AapiId][0][0];
							
						}else if(isset($_MarkupArray[0][0][0][0])){
							$_AttractionValues = $_MarkupArray[$_AaccountId][$_AapiId][0][0];
						}
						
						if($_AttractionValues['markup_amount'] !=0){
							$_IsMarkupApplied = true;
							$_Smarkup_fee 		= $_AttractionValues['markup_amount'];
							$_Smarkup_type 		= $_AttractionValues['markup_fee_type'];	
							$_Smarkup_source 	= $_AttractionValues['markup_type'];
						}
				...
				if(!$_IsMarkupApplied){
					//all
					if(isset($_MarkupArray[0][0])){
						
						if(isset($_MarkupArray[0][0][$_CountryIdIs][$_AticketVal['attraction']['id']])){
							
							$_AttractionValues = $_MarkupArray[0][0][$_CountryIdIs][$_AticketVal['attraction']['id']];
	
						}else if(isset($_MarkupArray[0][0][$_CountryIdIs][0])){
							
							$_AttractionValues = $_MarkupArray[0][0][$_CountryIdIs][0];
							
						}else if(isset($_MarkupArray[0][0][0][0])){
							$_AttractionValues = $_MarkupArray[0][0][0][0];
